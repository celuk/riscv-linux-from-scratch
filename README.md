...
It is used with [secure-soc](https://github.com/celuk/secure-soc), which is a CVA6 based SoC with secure boot and on-the-fly memory encryption-decryption. The old and messier version of this work is in [riscv-linux-boot](https://github.com/celuk/riscv-linux-boot). For a better linux port from scratch you can check [falcon-linux](https://github.com/gdrlab/falcon-linux).
